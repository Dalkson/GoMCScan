...
Options:
	...
	-F, --favicon enable saving of favicon images to output directory. (false)
`
	...
	flag.BoolVar(&config.saveFavicon, "F", false, "enables favicon saving")
	flag.BoolVar(&config.saveFavicon, "favicon", false, "enables favicon saving")
